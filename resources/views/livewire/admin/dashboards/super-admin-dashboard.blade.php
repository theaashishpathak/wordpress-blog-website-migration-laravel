<div class="mx-auto w-full space-y-8 ">
    ...
    ================================================================ --}}
    <div
        class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 p-8 text-white shadow-2xl">
...
<div class="absolute bottom-0 left-1/3 h-48 w-48 rounded-full bg-fuchsia-300/20 blur-3xl"></div>
<div class="absolute top-10 left-10 h-24 w-24 rounded-full border border-white/10"></div>
        <div class="relative grid gap-8  lg:items-center">
            {{-- Left --}}
            <div class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2 text-xs text-white/80">
                        <span
                            class="rounded-full bg-white/20 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em]">
                            Super Admin
                        </span>
            ...
            <div class="flex gap-2">
                @foreach ($this->quickActions as $action)
                    <a href="{{ $action['url'] }}" wire:navigate
                        class="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 text-sm font-semibold text-white transition hover:bg-white/20">
    ...
    @if ($alerts->isNotEmpty())
        <div class="space-y-2">
            @foreach ($alerts as $alert)
                <div
                    class="rounded-2xl border-l-4 {{ match ($alert->severity) {
                    ...
                    <div class="flex items-start gap-3">
                        <span
                            class="grid h-9 w-9 shrink-0 place-items-center rounded-lg {{ match ($alert->severity) {
    ...
    <div>
        <div class="mb-4 flex items-center gap-3">
            ...
            <p class="text-lg font-bold uppercase tracking-widest text-slate-400">Platform Overview</p>
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
        </div>

        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            <div
                class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
                <div class="flex items-center justify-between">
                    <span class="text-[10px] font-bold uppercase tracking-wider text-slate-500">Total Posts</span>
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-500 text-white">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-white">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 text-white">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 text-white">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-sky-500 to-indigo-500 text-white">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 text-white">
    ...
    <div>
        <div class="mb-4 flex items-center gap-3">
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
            <p class="text-lg font-bold uppercase tracking-widest text-slate-400">Content Pipeline</p>
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
        </div>
        ...
        <div class="grid gap-4 lg:grid-cols-4">
            ...
            <div
                ...
                <header
                    class="border-b border-slate-100 bg-slate-50/60 px-4 py-3 dark:border-slate-800 dark:bg-slate-800/50">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="rounded-full bg-slate-200 px-2 py-0.5 text-[10px] font-bold dark:bg-slate-700">{{ $this->draftPosts->count() }}</span>
                    </div>
                </header>
                <ul class="divide-y divide-slate-100 dark:divide-slate-800">
                    @forelse ($this->draftPosts as $post)
                        <li class="px-4 py-2.5 hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                            ...
                            <p class="text-[9px] text-slate-400">{{ $post->author?->name }} ·
            ...
            {{-- Pending Review --}}
            <div
                class="overflow-hidden rounded-2xl border border-amber-200 bg-white shadow-sm dark:border-amber-800/40 dark:bg-slate-900">
                <header
                    class="border-b border-amber-100 bg-amber-50/60 px-4 py-3 dark:border-amber-800/30 dark:bg-amber-900/20">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                        ...
                        <span
                            class="rounded-full bg-amber-200 px-2 py-0.5 text-[10px] font-bold dark:bg-amber-500/30">{{ $this->pendingReviewPosts->count() }}</span>
                    </div>
                </header>
                <ul class="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            {{-- Scheduled --}}
            <div
                class="overflow-hidden rounded-2xl border border-violet-200 bg-white shadow-sm dark:border-violet-800/40 dark:bg-slate-900">
                <header
                    class="border-b border-violet-100 bg-violet-50/60 px-4 py-3 dark:border-violet-800/30 dark:bg-violet-900/20">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                        ...
                        <span
                            class="rounded-full bg-violet-200 px-2 py-0.5 text-[10px] font-bold dark:bg-violet-500/30">{{ $this->scheduledPosts->count() }}</span>
                    </div>
                </header>
                <ul class="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            {{-- Ready to Publish --}}
            <div
                class="overflow-hidden rounded-2xl border border-emerald-200 bg-white shadow-sm dark:border-emerald-800/40 dark:bg-slate-900">
                <header
                    class="border-b border-emerald-100 bg-emerald-50/60 px-4 py-3 dark:border-emerald-800/30 dark:bg-emerald-900/20">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                        ...
                        <span
                            class="rounded-full bg-emerald-200 px-2 py-0.5 text-[10px] font-bold dark:bg-emerald-500/30">{{ $this->readyToPublishPosts->count() }}</span>
                    </div>
                </header>
                <ul class="divide-y divide-slate-100 dark:divide-slate-800">
        ...
        <div
            ...
            <div class="mb-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <span
                        class="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 text-white">
                ...
                @if ($schedule['missed']->isNotEmpty())
                    <span
                        class="rounded-full bg-rose-100 px-3 py-1 text-[10px] font-bold text-rose-700 dark:bg-rose-500/20 dark:text-rose-300">
            ...
            @if ($schedule['next'])
                <div
                    class="mb-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 p-4 dark:from-violet-500/10 dark:to-purple-500/10">
                    <p class="text-[10px] font-bold uppercase tracking-wider text-violet-600 dark:text-violet-400">Next
                        publication</p>
                    <div class="mt-1 flex items-center justify-between">
                        ...
                        <span
                            class="rounded-full bg-violet-200 px-3 py-1 text-xs font-bold text-violet-700 dark:bg-violet-500/30 dark:text-violet-300">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        ...
        <div
            class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <header
                class="flex items-center justify-between border-b border-slate-100 px-5 py-3 dark:border-slate-800">
                ...
                <a href="{{ route('admin.posts.index') }}" wire:navigate
                    class="text-xs font-semibold text-indigo-600 hover:underline">View all →</a>
            </header>
            <ul class="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <li class="flex items-start gap-3 px-5 py-3 hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="text-[11px] text-slate-500">
                                <span
                                    class="font-medium text-slate-700 dark:text-slate-300">{{ $post->author?->name ?? '—' }}</span>
            ...
            <ul class="divide-y divide-slate-100 dark:divide-slate-800">
                @forelse ($this->recentlyUpdated as $post)
                    <li class="flex items-start gap-3 px-5 py-3 hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                        ...
                        <span
                            class="rounded-md px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider {{ match ($post->status?->value) {
    ...
    <div>
        <div class="mb-4 flex items-center gap-3">
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
            <p class="text-lg font-bold uppercase tracking-widest text-slate-400">Recent Activity Feed</p>
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
        </div>
            ...
            <ul class="divide-y divide-slate-100 dark:divide-slate-800">
                @forelse ($this->activityFeed as $activity)
                    <li class="flex items-center gap-4 px-5 py-3 hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                        <span
                            class="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-gradient-to-br {{ $activity->color }} text-white">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="text-[11px] text-slate-500">
                                <span
                                    class="font-medium text-slate-700 dark:text-slate-300">{{ $activity->user }}</span>
                                · {{ $activity->action }}
    ...
    <div>
        <div class="mb-4 flex items-center gap-3">
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
            <p class="text-lg font-bold uppercase tracking-widest text-slate-400">Performance Insights</p>
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
        </div>
            ...
            <div
                ...
                <div class="mt-3 space-y-2">
                    <div
                        ...
                        <span
                            class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ $pubStats['weekly'] }}</span>
                    </div>
                    <div
                        class="flex items-center justify-between border-b border-slate-100 pb-2 dark:border-slate-800">
                        <span class="text-sm text-slate-600 dark:text-slate-400">This Month</span>
                        <span
                            class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ $pubStats['monthly'] }}</span>
                    </div>
                    <div
                        class="flex items-center justify-between border-b border-slate-100 pb-2 dark:border-slate-800">
                        <span class="text-sm text-slate-600 dark:text-slate-400">This Year</span>
                        <span
                            class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ $pubStats['yearly'] }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-semibold text-slate-700 dark:text-slate-300">Total Published</span>
                        <span
                            class="text-xl font-black text-emerald-600 dark:text-emerald-400">{{ number_format($pubStats['total']) }}</span>
                    </div>
                </div>
            </div>
                ...
                <ul class="divide-y divide-slate-100 dark:divide-slate-800">
                    @forelse ($this->mostViewedPosts as $i => $p)
                        <li class="flex items-center gap-3 px-5 py-2.5">
                            <span
                                class="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-gradient-to-br from-amber-500 to-orange-500 text-[10px] font-black text-white">
                                #{{ $i + 1 }}
                            </span>
                    ...
                    @forelse ($topCats as $cat)
                        <li>
                            <div class="mb-0.5 flex items-center justify-between text-xs">
                                <span
                                    class="font-semibold text-slate-700 dark:text-slate-200">{{ $cat->category_name }}</span>
                                <div class="flex items-center gap-3">
                                    <span class="font-mono text-slate-500">{{ $cat->post_count }} posts</span>
                                    <span
                                        class="font-mono text-xs text-slate-400">{{ number_format($cat->total_views) }}
                                        views</span>
                                </div>
                            </div>
    ...
    <div>
        <div class="mb-4 flex items-center gap-3">
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
            <p class="text-lg font-bold uppercase tracking-widest text-slate-400">Team Performance</p>
            <span class="h-px flex-1 bg-slate-200 dark:bg-slate-700"></span>
        </div>
        ...
        <div
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead>
                        <tr
                            class="border-b border-slate-200 bg-slate-50/60 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:border-slate-800 dark:bg-slate-800/50">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        @forelse ($this->authorPerformance as $author)
                            <tr class="hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                                <td class="px-5 py-3">
                                    <div class="flex items-center gap-3">
                                        <span
                                            class="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-gradient-to-br from-sky-500 to-indigo-500 text-[10px] font-bold uppercase text-white">
                                            {{ mb_substr($author->name, 0, 1) }}
                                        </span>
                                        <span
                                            class="font-semibold text-slate-700 dark:text-slate-200">{{ $author->name }}</span>
                                    </div>
                                </td>
                                <td class="px-5 py-3 text-center">
                                    <span
                                        class="rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-bold text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-5 py-8 text-center text-xs text-slate-500">No author data
                                    available.</td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="mb-4 flex items-center justify-between">
            <div>
                <h3 class="text-sm font-bold text-slate-800 dark:text-slate-100">📈 Publishing Trend · Last 30 Days
                </h3>
